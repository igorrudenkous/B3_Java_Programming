...
public class HashMap {
    public static void main(String[] args) {
        ...
        Map <String, Map<String, String>> infoPeopleAndCountry = new java.util.HashMap<>();

        Map <String, String> mapOne = new java.util.HashMap<>();
        mapOne.put("Tom", "Jerry");
        mapOne.put("Mickey", "Mouse");

        Map <String , String> mapTwo = new java.util.HashMap<>();
